		...
		<section className="dark:bg-jacarta-800 relative py-24">
			...
			<div className="container">
				...
				<p className="text-jacarta-700 mx-auto mt-20 max-w-2xl text-center text-lg dark:text-white">
					Recuerda que 5.0 Music no solo es arte gráfico, Tu NFT es la llave para tener contenido exclusivo de tu artista antes que nadie, asi como lives, videos, acceso a eventos, y mucho más.
				</p>
